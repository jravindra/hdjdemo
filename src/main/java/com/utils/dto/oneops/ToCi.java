...
public class ToCi implements Serializable
{

    @JsonProperty("attrProps")
    private AttrProps_ attrProps;
    ...
    private final static long serialVersionUID = -5725182161148350119L;

    @JsonProperty("attrProps")
    public AttrProps_ getAttrProps() {
        return attrProps;
    }

    @JsonProperty("attrProps")
    public void setAttrProps(AttrProps_ attrProps) {
